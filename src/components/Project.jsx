...
return(
<div className="border rounded-t-lg border-black text-center my-8  mx-6 ">
  <a target="_blank" href={proyecto.link} ><img className=" rounded-t-lg" src={imgUrl}/></a>
  <section className="py-2">
  <a target="_blank" href={proyecto.link}><h2 className="text-4xl border-b border-b-black">{proyecto.nombre}</h2></a>
